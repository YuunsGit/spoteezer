            ...
            >
              ...
              <div className="flex w-full items-center justify-between px-4">
                ...
                <button
                  ...
                  className="bg-spotigreen z-10 flex size-12 cursor-default items-center justify-center rounded-full opacity-0 shadow-[0_8px_8px_rgb(0_0_0_/_30%)] transition-opacity hover:scale-105 hover:brightness-105 group-hover:opacity-100"
                >
                  <PlayNowIcon
                    role="img"
                    aria-hidden
